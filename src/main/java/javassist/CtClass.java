...
public abstract class CtClass {
     ...
     * @see javassist.CtMember#getAnnotations()
     * @since 3.1
     */
     ...
     * @return an array of annotation-type objects.
     * @see #getAnnotations()
     * @see javassist.CtMember#getAvailableAnnotations()
     * @since 3.3
     */
     ...
     * @see #replaceClassName(javassist.ClassMap)
     */
     ...
     * @throws javassist.NotFoundException   if the constructor is not found.
     */
     ...
     * @throws javassist.NotFoundException   if the method is not found.
     */
     ...
     *
     * @see CtField#CtField(javassist.CtField, javassist.CtClass)
     */
     ...
     * @throws javassist.NotFoundException   if the field is not found.
     */
     ...
     * @see javassist.ClassPool#toClass(javassist.CtClass)
     */
     ...
     *                      {@link javassist.ClassPool#getClassLoader()} is used.
     ...
     * @see javassist.ClassPool#toClass(javassist.CtClass,ClassLoader)
     * @since 3.3
     */
     ...
     * @see #detach()
     * @see #prune()
     * @see javassist.ClassPool#doPruning
     */
     ...
     * @see #toClass()
     * @see #writeFile()
     * @see #instrument(javassist.CodeConverter)
     * @see #instrument(javassist.expr.ExprEditor)
     */
    public void prune() {}
