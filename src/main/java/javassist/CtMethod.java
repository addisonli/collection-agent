 ...
 *
 * @see javassist.CtClass#getDeclaredMethods()
 * @see javassist.CtNewMethod
 */
public final class CtMethod extends CtBehavior {
     ...
     *
     * @see javassist.CtClass#addMethod(javassist.CtMethod)
     */
     ...
     *
     * @see javassist.CtClass#addMethod(javassist.CtMethod)
     * @see javassist.ClassMap#fix(String)
     */
     ...
     * @param declaring    the class to which the created method is added.
     * @see javassist.CtNewMethod#make(String, javassist.CtClass)
     */
     ...
     * @throws javassist.CannotCompileException       if the the <code>MethodInfo</code>
     ...
     *
     * @see javassist.CtNewMethod#wrapped(javassist.CtClass,String, javassist.CtClass[], javassist.CtClass[], javassist.CtMethod, javassist.CtMethod.ConstParameter, javassist.CtClass)
     */
     ...
     *
     * @see javassist.CtMethod#setWrappedBody(javassist.CtMethod, javassist.CtMethod.ConstParameter)
     * @see javassist.CtNewMethod#wrapped(javassist.CtClass,String, javassist.CtClass[], javassist.CtClass[], javassist.CtMethod, javassist.CtMethod.ConstParameter, javassist.CtClass)
     * @see javassist.CtNewConstructor#make(javassist.CtClass[], javassist.CtClass[],int, javassist.CtMethod, javassist.CtMethod.ConstParameter, javassist.CtClass)
     */
    public static class ConstParameter {
        ...
        /**
         * @see javassist.CtNewWrappedMethod
         */
         ...
         *
         * @see javassist.CtNewWrappedConstructor
         */
