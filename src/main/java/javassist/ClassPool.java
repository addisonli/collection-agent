...
public class ClassPool {
     ...
     * @see #removeCached(String, javassist.CtClass)
     */
     ...
     * @see javassist.bytecode.Descriptor#toCtClass(String, javassist.ClassPool)
     * @since 3.8.1
     */
     ...
     * @see javassist.CtClass#getDeclaredMethod(String)
     */
     ...
     *
     * @return the inserted class path.
     * @throws javassist.NotFoundException    if the jar file is not found.
     */
     ...
     *                      separator ("/").
     * @throws javassist.NotFoundException if a jar file is not found.
     */
     ...
     *
     * @see #toClass(javassist.CtClass, ClassLoader, java.security.ProtectionDomain)
     * @see #getClassLoader()
     */
     ...
     * @see #toClass(javassist.CtClass)
     * @see javassist.CtClass#getAnnotations()
     */
     ...
     * protection domain is not specified.
     *
     * @deprecated      Replaced by {@link #toClass(javassist.CtClass,ClassLoader, java.security.ProtectionDomain)}.
     * A subclass of <code>ClassPool</code> that has been
     * overriding this method should be modified.  It should override
     * {@link #toClass(javassist.CtClass,ClassLoader, java.security.ProtectionDomain)}.
     */
