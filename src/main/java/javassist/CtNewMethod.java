...
public class CtNewMethod {
     ...
     *
     * @see javassist.CtMethod#CtMethod(javassist.CtMethod, javassist.CtClass, javassist.ClassMap)
     */
     ...
     * @param declaring    the class to which the created method is added.
     *
     * @see javassist.CtMethod#CtMethod(javassist.CtClass,String, javassist.CtClass[], javassist.CtClass)
     */
