 ...
 *
 * @see javassist.bytecode.CodeIterator
 */
public class CodeAttribute extends AttributeInfo implements Opcode {
     ...
     * @param classnames        pairs of replaced and substituted
     *                          class names.
     * @exception javassist.bytecode.CodeAttribute.RuntimeCopyException  if a <code>BadBytecode</code>
     ...
     *
     * @throws javassist.bytecode.BadBytecode      if this method fails in computing.
     ...
     *
     * @see javassist.bytecode.LocalVariableAttribute#shiftIndex(int, int)
     * @see javassist.bytecode.StackMapTable#insertLocal(int, int, int)
     */
