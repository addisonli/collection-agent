 ...
 * ireturn</pre></ul>
 *
 * @see javassist.bytecode.ConstPool
 * @see javassist.bytecode.CodeAttribute
 */
public class Bytecode extends ByteVector implements Cloneable, Opcode {
     ...
     * 
     * @param cp            constant pool table.
     * @see javassist.bytecode.Bytecode#setMaxStack(int)
     * @see javassist.bytecode.Bytecode#setMaxLocals(int)
     */
     ...
     *
     * @see javassist.bytecode.Descriptor#of(javassist.CtClass)
     */
     ...
     *
     * @see javassist.bytecode.Descriptor#ofMethod(javassist.CtClass, javassist.CtClass[])
     * @see javassist.bytecode.Descriptor#ofConstructor(javassist.CtClass[])
     */
