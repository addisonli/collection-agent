 ...
 *
 * @see javassist.CtClass#addConstructor(javassist.CtConstructor)
 * @see javassist.CtClass#makeClassInitializer()
 */
public class CtNewConstructor {
     ...
     *
     * @see javassist.CtConstructor#CtConstructor(javassist.CtConstructor, javassist.CtClass, javassist.ClassMap)
     */
     ...
     *                          is added.
     * @see javassist.CtField.Initializer#byParameter(int)
     */
