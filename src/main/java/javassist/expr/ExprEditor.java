 ...
 *
 * @see javassist.CtClass#instrument(javassist.expr.ExprEditor)
 * @see javassist.CtMethod#instrument(javassist.expr.ExprEditor)
 * @see javassist.CtConstructor#instrument(javassist.expr.ExprEditor)
 * @see javassist.expr.MethodCall
 * @see javassist.expr.NewExpr
 * @see javassist.expr.FieldAccess
 *
