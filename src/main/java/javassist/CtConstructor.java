 ...
 *
 * @see javassist.CtClass#getDeclaredConstructors()
 * @see javassist.CtClass#getClassInitializer()
 * @see javassist.CtNewConstructor
 */
public final class CtConstructor extends CtBehavior {
     ...
     * @see javassist.CtConstructor#setBody(String)
     * @see javassist.CtConstructor#setBody(javassist.CtConstructor, javassist.ClassMap)
     */
