...
public class Loader extends ClassLoader {
     ...
     * @throws javassist.NotFoundException        if <code>t.start()</code> throws an exception.
     * @throws javassist.CannotCompileException   if <code>t.start()</code> throws an exception.
     */
