 ...
 *
 * @see #get(Object)
 * @see javassist.CtClass#replaceClassName(javassist.ClassMap)
 * @see javassist.CtNewMethod#copy(javassist.CtMethod,String, javassist.CtClass, javassist.ClassMap)
 */
