 ...
 *
 * @see javassist.CtClass#getDeclaredFields()
 */
public class CtField extends CtMember {
     ...
     *
     * @see javassist.CtClass#addField(javassist.CtField)
     * @see javassist.CtNewMethod#getter(String, javassist.CtField)
     * @see javassist.CtNewMethod#setter(String, javassist.CtField)
     * @see javassist.CtField.Initializer
     */
     ...
     *
     * @see javassist.CtClass#addField(javassist.CtField, javassist.CtField.Initializer)
     */
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see javassist.CtField.Initializer#byNewArray(javassist.CtClass,int)
         * @see javassist.CtField.Initializer#byNewArray(javassist.CtClass,int[])
         */
         ...
         * @throws javassist.NotFoundException    if the type of the array components
         *                              is not found.
         */
