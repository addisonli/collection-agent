...
public interface Translator {
     ...
     * @throws javassist.NotFoundException    if a <code>CtClass</code> cannot be found.
     * @throws javassist.CannotCompileException   if the initialization by this method
     *                                  fails.
     */
     ...
     * @see javassist.Loader
     * @throws javassist.NotFoundException    if a <code>CtClass</code> cannot be found.
     * @throws javassist.CannotCompileException   if the code transformation
